...
async function startCheckout() {
    try {
        ...
        statusUI.setStatus(
            t(getLanguage(), "cart_checkout_intent"),
            "neutral",
            null,
        );
        ...
        statusUI.setDebug(checkoutSession);

        const checkoutUrl = checkoutSession?.checkout_url;
        if (!checkoutUrl) {
            statusUI.setStatus(
                t(getLanguage(), "cart_checkout_failed"),
                "bad",
                500,
            );
            return;
        ...
        statusUI.setStatus(t(getLanguage(), "cart_checkout_redirect"), "ok", 200);
