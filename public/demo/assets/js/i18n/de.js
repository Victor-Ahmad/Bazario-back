export default {
    ...
    cart_checkout_intent: "Stripe-Checkout-Session wird erstellt...",
    cart_checkout_redirect: "Weiterleitung zu Stripe Checkout...",
    ...
    admin_settings_title: "Plattform-Einstellungen",
    admin_settings_subtitle: "Plattformgebuehr und Preise fuer Promotionen im Marktplatz konfigurieren.",
    admin_settings_platform_fee: "Plattformgebuehr (%)",
    admin_settings_announcement_price: "Preis pro Tag fuer Ankuendigungen",
    admin_settings_gold_price: "Preis pro Tag fuer Gold-Anzeigen",
    admin_settings_silver_price: "Preis pro Tag fuer Silber-Anzeigen",
    admin_settings_normal_price: "Preis pro Tag fuer Standard-Anzeigen",
    admin_settings_save: "Einstellungen speichern",
    admin_settings_saving: "Einstellungen werden gespeichert...",
    admin_settings_success: "Plattform-Einstellungen aktualisiert.",
    ...
    order_success_paid: "Zahlung bestaetigt. Warenkorb geleert.",
    order_success_pending: "Zahlung gesendet, warte auf Bestaetigung...",
    order_success_pending_subtitle:
        "Die Zahlung wird per Webhook bestaetigt. Diese Seite aktualisiert sich automatisch.",
